...
<nav class="sticky top-0 z-50 bg-white border-b border-gray-100 shadow-sm">
    <div class="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
        ...
        <div class="flex items-center gap-4">
            ...
            <a href="#" class="text-xs font-bold uppercase text-gray-500 hover:text-orange-500 transition">
                Member Login
            </a>
...
<footer class="bg-[#05070a] text-gray-400 mt-20">
    ...
    <div class="border-t border-gray-800">
        <div class="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row justify-between gap-4 text-xs">
            ...
            <p>
                © {{ date('2026') }} Global Education, Skills & Training Accreditation Authority Canada (GESTAAC).
            </p>
